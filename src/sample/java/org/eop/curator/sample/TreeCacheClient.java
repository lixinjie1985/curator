...
public class TreeCacheClient {
	...
	public static void main(String[] args) throws Exception {
		...
		client.create().creatingParentsIfNeeded().withMode(CreateMode.PERSISTENT).inBackground().forPath("/curator/child/gdson", "你好".getBytes());
		System.out.println("--------------------------孙节点创建-------------------------");
		Thread.sleep(2000);
		
		client.setData().withVersion(-1).inBackground().forPath("/curator/child/gdson", "我好".getBytes());
		System.out.println("--------------------------孙节点更新-------------------------");
		Thread.sleep(2000);
		
		client.delete().deletingChildrenIfNeeded().withVersion(-1).inBackground().forPath("/curator/child/gdson");
		System.out.println("--------------------------孙节点删除-------------------------");
		Thread.sleep(2000);
