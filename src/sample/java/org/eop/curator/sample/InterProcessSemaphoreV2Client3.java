 ...
 * @author lixinjie
 */
public class InterProcessSemaphoreV2Client3 {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("-------------------3开始获取一个租赁------------------");
		lease = semaphore.acquire();
		System.out.println("-------------------3已经获取一个租赁------------------");
		...
		System.out.println("-------------------3开始获取多个租赁------------------");
		leases = semaphore.acquire(6);
		System.out.println("-------------------3已经获取多个租赁------------------");
		...
		System.out.println("-------------------3开始释放一个租赁------------------");
		semaphore.returnLease(lease);
		System.out.println("-------------------3已经释放一个租赁------------------");
		System.out.println("participant=" + semaphore.getParticipantNodes());
		
		System.out.println("-------------------3开始释放多个租赁------------------");
		semaphore.returnAll(leases);
		System.out.println("-------------------3已经释放多个租赁------------------");
		System.out.println("participant=" + semaphore.getParticipantNodes());
		System.out.println("3租赁数，现在是：" + count.getCount());
		count.close();
		client.close();
	}
}
